                ...
                <div class="controls">
                  <select name="subsubcategory_id" class="form-control">
                    ...
                    @foreach ($subsubcategory as $subsubcategory)
                     <option value="{{ $subsubcategory->id }}" {{ $subsubcategory->id == $products->subsubcategory_id ? 'selected' :'' }}> {{ $subsubcategory->subsubcategory_name_en }}
                     </option>
                    @endforeach
                  </select>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="controls">
                  <input type="text" name="product_color_bn" class="form-control" value="{{ $products->product_color_bn }}" data-role="tagsinput"> 
        ...
        <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="controls">
                  <textarea name="short_des_en" id="textarea" class="form-control" required placeholder="Textarea text" > {{ $products->short_des_en }}
                  </textarea>
                </div>
              </div>
            </div> 
           ...
           <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="controls">
                <textarea name="short_des_bn" id="textarea" class="form-control" required placeholder="Textarea text"> {{ $products->short_des_bn }}
                </textarea>
              </div>
            </div>
           </div>   
                  ...
                  <form method="post" action="{{ route('product.image.update') }}" enctype="multipart/form-data">
                    ...
                    <div class="row row-sm">
                        ...
                        <div class="col-md-3">
                          ...
                          <div class="card">
                            <img class="card-img-top" src="{{ asset($img->photo_name) }}" styles="height:120px; width:280px">
                            <div class="card-body">
                              <h5 class="card-title">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
			<div class="box bt-3 border-info">
                  ...
                  <form method="post" action="{{ route('product.thumbnail.update') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row row-sm">
                        <div class="col-md-12">
                          ...
                          <div class="card">
                            <img class="card-img-top" src="{{ asset($products->product_thumbnail) }}" styles="height:120px; width:280px">
                            <div class="card-body">
                              <h5 class="card-title">
